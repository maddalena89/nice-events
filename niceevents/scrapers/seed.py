...
SEED: list[tuple] = [
    ...
    ("2026-07-03", "2027-01-03", "Victor Brauner — The Magical Adventure", "Monaco", "Nouveau Musée National de Monaco · Villa Paloma", "expo", "Over 160 works by Surrealist Victor Brauner from a Monaco collection", "https://www.visitmonaco.com/en/events/monaco-s-major-events/grimaldi-forum-monaco-summer-exhibition", False),

    # ---- exhibitions: the coast ----
    ("2026-06-12", "2026-09-20", "Temporary exhibition at Villa Kérylos", "Beaulieu-sur-Mer", "Villa Kérylos", "expo", "Sculptures and jewellery by Harumi Klossowska de Rola", "https://www.explorenicecotedazur.com/en/event/temporary-exhibition-at-villa-kerylos/", False),
    ("2026-07-01", "2026-07-30", "Sabine Vandenbulcke — The Studio by the Sea", "Beaulieu-sur-Mer", "", "expo", "Abstract works inspired by light and the sea", "https://www.explorenicecotedazur.com/en/event/exhibition-by-sabine-vandenbulcke-the-studio-by-the-sea/", False),
    ("2026-07-02", "2026-10-31", "L'Absurde et Le Rêve — summer exhibition", "Villefranche-sur-Mer", "", "expo", "Surreal works by Arne Quinze and Joana Vasconcelos", "https://www.explorenicecotedazur.com/en/event/labsurde-et-le-reve-summer-exhibition/", False),
    ("2026-07-03", "2026-09-03", "La vie en rose", "Villefranche-sur-Mer", "Hôtel Provençal", "expo", "Contemporary works united by the colour pink", "https://www.explorenicecotedazur.com/en/event/la-vie-en-rose-exhibition-at-the-hotel-provencal/", False),
    ("2026-07-03", "2027-01-04", "80th Anniversary of the Grimaldi Castle Museum", "Cagnes-sur-Mer", "Château-Musée Grimaldi", "expo", "80 years of the museum collection, from olive heritage to modern art", "https://www.explorenicecotedazur.com/en/event/exhibition-the-80th-anniversary-of-the-grimaldi-castle-museum/", False),
    ("2026-06-04", "2026-09-20", "Destination Bijou", "Cagnes-sur-Mer", "", "expo", "Three contemporary jewellery shows, including a Herman Hermsen retrospective", "https://www.explorenicecotedazur.com/en/event/destination-bijou-cagnes/", False),
    ("2026-05-13", "2026-09-04", "Il cuore della terra — Cesare Catania", "Saint-Jean-Cap-Ferrat", "", "expo", "Cesare Catania's three-metre steel sculpture with augmented reality", "https://www.explorenicecotedazur.com/en/event/il-cuore-della-terra-exhibition-by-cesare-catania/", False),
    ("2026-06-12", "2026-10-11", "Cerises aux cœurs — Jean-Louis Landraud", "Saint-Jean-Cap-Ferrat", "Open-air sculpture trail", "expo", "Open-air bronze cherry sculptures by Jean-Louis Landraud", "https://www.explorenicecotedazur.com/en/event/cerises-aux-coeurs-open-air-sculpture-exhibition-by-jean-louis-landraud/", False),
    ("2026-04-01", "2026-08-30", "Ramiro Arrue", "Cap-d'Ail", "", "expo", "Paintings of Basque landscapes and daily life by Ramiro Arrue", "https://www.explorenicecotedazur.com/en/event/ramiro-arrue-exhibition/", False),

    # ---- exhibitions: Èze & hinterland ----
    ("2026-07-12", "2026-07-30", "Exposition F. Suzanne 2026", "Èze", "", "expo", "Paintings blending primitive and contemporary art", "https://www.explorenicecotedazur.com/en/event/exposition-f-suzanne-2026/", False),
    ("2026-08-15", "2026-08-31", "Exposition Maja Kerin", "Èze", "", "expo", "Abstract pictorial photography by Maja Kerin", "https://www.explorenicecotedazur.com/en/event/exposition-maja-kerin-aout-2026/", False),
    ("2026-09-02", "2026-09-14", "Exposition Corinne Canta", "Èze", "", "expo", "Stylized portraits of women and abstract canvases", "https://www.explorenicecotedazur.com/en/event/exposition-corinne-canta-2026/", False),
    ("2026-08-01", "2026-12-18", "Expositions AMSL Aquarelle & « Levens d'un temp è de deman »", "Levens", "", "expo", "Watercolours and photography celebrating Levens heritage", "https://www.explorenicecotedazur.com/en/event/expositions-de-lamsl-aquarelle-et-de-lassociation-levens-dun-temp-e-de-deman/", False),
    ("2026-07-09", "2026-11-01", "Mémoires de l'eau", "Vence", "", "expo", "Six immersive sound and light installations on water", "https://www.explorenicecotedazur.com/en/event/exposition-memoires-de-leau/", False),
    ("2026-07-04", "2026-08-29", "Escales littorales", "Saint-Martin-Vésubie", "", "expo", "Mediterranean marine biodiversity, from seahorses to Posidonia meadows", "https://www.explorenicecotedazur.com/en/event/exhibition-escales-littorales/", False),
